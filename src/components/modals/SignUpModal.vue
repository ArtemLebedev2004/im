<template>
    <div v-if="!open" class="absolute z-20 inset-0 h-screen flex flex-col bg-white">
        ...
        <div class="px-3 min-[568px]:px-5 min-[640px]:px-8 xl:px-10 min-[1366px]:px-12 2xl:px-14 py-6 min-[1920px]:py-10 flex flex-col overflow-auto">
            ...
            <form class="my-10 min-[1920px]:my-16 overflow-auto">
                ...
                <div @click="open = !open" class="relative mt-9 pr-2">
...
<script setup>
import CroppedImage from '@/components/reusable/CroppedImage.vue'
